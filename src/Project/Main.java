...
public class Main {
    ...
    public static void displayStaff(ArrayList<Staff> employees) {
        try (BufferedReader reader = new BufferedReader(new FileReader("src/Project/staff_details.txt"))) {
            int staffCount = 0;
    ...
    public static void addStaff() {
        ...
        do {
            ...
            try (
                    FileWriter out = new FileWriter("src/Project/staff_details.txt", true)) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Staff> employees = loadFile("src/Project/staff_details.txt");
        menu(employees);
